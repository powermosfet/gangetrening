...
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {language: a, maximum: b, multiplications: c, gameState: d};
	});
...
var _user$project$Commands$createMultsforN = function (n) {
	return A2(
		_elm_lang$core$List$map,
		function (m) {
			return {ctor: '_Tuple3', _0: n, _1: m, _2: ''};
		},
		A2(_elm_lang$core$List$range, 1, 10));
};
var _user$project$Commands$createMultiplications = function (maximum) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			_user$project$Commands$createMultsforN,
			A2(_elm_lang$core$List$range, 1, maximum)));
};
var _user$project$Commands$createShuffledMultiplications = function (model) {
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$Message$NewMultiplications,
		_elm_community$random_extra$Random_List$shuffle(
			_user$project$Commands$createMultiplications(model.maximum)));
};

var _user$project$Routing$parseLang = function (lang) {
	var _p0 = lang;
	switch (_p0) {
		case 'nor':
			return _elm_lang$core$Result$Ok(_user$project$Translations_Types$Nor);
		case 'eng':
			return _elm_lang$core$Result$Ok(_user$project$Translations_Types$Eng);
		default:
			return _elm_lang$core$Result$Err(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Could not parse language \'',
...
var _user$project$Routing$SettingsRoute = F2(
	function (a, b) {
		return {ctor: 'SettingsRoute', _0: a, _1: b};
	});
var _user$project$Routing$RootRoute = {ctor: 'RootRoute'};
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routing$RootRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routing$SettingsRoute,
				A2(_evancz$url_parser$UrlParser_ops['</>'], _user$project$Routing$lang, _evancz$url_parser$UrlParser$int)),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Init$init = function (loc) {
	var route = _user$project$Routing$parseLocation(loc);
	var _p0 = function () {
		var _p1 = route;
		if (_p1.ctor === 'SettingsRoute') {
			return {ctor: '_Tuple2', _0: _p1._0, _1: _p1._1};
		} else {
			return {ctor: '_Tuple2', _0: _user$project$Translations_Types$Eng, _1: 4};
		}
	}();
	var lang = _p0._0;
	var max = _p0._1;
...
var _user$project$Update$changeAnswer = F2(
	function (ans, _p0) {
		var _p1 = _p0;
		return {ctor: '_Tuple3', _0: _p1._0, _1: _p1._1, _2: ans};
	});
var _user$project$Update$updateFirst = F2(
	function (f, list) {
		var _p2 = list;
		if (_p2.ctor === '::') {
			return {
...
var _user$project$Update$rotate = function (list) {
	var _p3 = list;
	if (_p3.ctor === '::') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Update$rotateUntil_ = F3(
	function (f, max, list) {
		rotateUntil_:
		while (true) {
			var _p4 = list;
			if (_p4.ctor === '::') {
				var done = (_elm_lang$core$Native_Utils.cmp(max, 0) < 1) || f(_p4._0);
				var rotated = _user$project$Update$rotate(list);
				if (done) {
					return list;
				} else {
					var _v4 = f,
...
var _user$project$Update$rotateUntil = F2(
	function (f, list) {
		return A3(
			_user$project$Update$rotateUntil_,
			f,
			_elm_lang$core$List$length(list),
			list);
	});
var _user$project$Update$changeIf = F3(
	function (test, changed, original) {
		return test ? changed : original;
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'ChangeLocation':
				var _p6 = _user$project$Init$init(_p5._0);
				var initModel = _p6._0;
				return nop(
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'NewAnswer':
				return nop(
					_elm_lang$core$Native_Utils.update(
						...
						{
							multiplications: A2(
								_user$project$Update$updateFirst,
								_user$project$Update$changeAnswer(_p5._0),
			...
			default:
				var mults = A2(
					...
					function (_p7) {
						return !_user$project$Model$isCorrect(_p7);
					},
					_user$project$Update$rotate(model.multiplications));
				var gameState = A3(
					_user$project$Update$changeIf,
					A2(_elm_lang$core$List$all, _user$project$Model$isCorrect, mults),
					_user$project$Model$Finished,
					model.gameState);
				return nop(
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Styles_Constants$circle = {r: 16, stroke: 2};
var _user$project$Styles_Constants$margins = {
	small: _rtfeldman$elm_css$Css$rem(0.3),
	medium: _rtfeldman$elm_css$Css$rem(1)
};
var _user$project$Styles_Constants$colors = {
...
var _user$project$Styles_Styles$css = function () {
	var margins = _user$project$Styles_Constants$margins;
	var colors = _user$project$Styles_Constants$colors;
	var circle = _user$project$Styles_Constants$circle;
	return function (_p0) {
		return _rtfeldman$elm_css$Css$stylesheet(
			A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_Constants$gangetrening, _p0));
	}(
		{
			ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('bs-navbar-collapsible'),
									_1: {ctor: '[]'}
								}
							},
							{
											...
											},
											{
												...
												_0: A2(
													...
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															t(_user$project$Translations_Types$CurrentMaximum)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(model.maximum)),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$span,
...
var _user$project$ScoreRing$separatorList = function (sep) {
	return function (_p0) {
		return A2(
			_elm_lang$core$String$join,
			sep,
			A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, _p0));
	};
};
var _user$project$ScoreRing$commaList = _user$project$ScoreRing$separatorList(', ');
var _user$project$ScoreRing$spaceList = _user$project$ScoreRing$separatorList(' ');
var _user$project$ScoreRing$class_ = function (_p1) {
			...
			A2(
				...
				function (_p2) {
					return A2(
						...
						_user$project$Styles_Constants$gangetrening,
						_elm_lang$core$Basics$toString(_p2));
				},
				_p1)));
};
var _user$project$ScoreRing$makeCircle = F4(
	function (n, total, radius, cls) {
		var circumference = (2 * _elm_lang$core$Basics$pi) * radius;
		var arc = circumference / _elm_lang$core$Basics$toFloat(total);
		var circleConstants = _user$project$Styles_Constants$circle;
		var centerOffset = radius + (circleConstants.stroke / 2);
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Attributes$cx(
						_elm_lang$core$Basics$toString(centerOffset)),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'stroke-dasharray',
										_1: _user$project$ScoreRing$commaList(
											{
												ctor: '::',
												_0: n * arc,
												_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$ScoreRing$class_(
									{
										ctor: '::',
										_0: _user$project$Styles_Classes$Circle,
										_1: {
											ctor: '::',
											_0: cls,
											_1: {ctor: '[]'}
	...
	return A2(
		_elm_lang$html$Html$figure,
		{
			...
			_0: _user$project$ScoreRing$class_(
				{
					ctor: '::',
					_0: _user$project$Styles_Classes$CircleFigure,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
					...
					_0: A2(
						_elm_lang$svg$Svg$svg,
						{
							...
							_0: _elm_lang$svg$Svg_Attributes$viewBox(
								_user$project$ScoreRing$spaceList(
									{
										ctor: '::',
										_0: 0,
										_1: {
...
var _user$project$View$helpers = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_user$project$Styles_Constants$gangetrening);
var _user$project$View$class_ = _user$project$View$helpers.$class;
var _user$project$View$ringContent = function (model) {
	...
	var innerContent = function () {
		...
		switch (_p0.ctor) {
			...
			case 'Running':
				var _p1 = model.multiplications;
				if ((_p1.ctor === '::') && (_p1._0.ctor === '_Tuple3')) {
					return A2(
						...
						},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(_p1._0._1)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(' = '),
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(_p1._0._2),
														_1: {
															ctor: '::',
...
var _user$project$Main$main = A2(
	...
	_user$project$Message$ChangeLocation,
	{init: _user$project$Init$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})();

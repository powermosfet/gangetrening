...
var _user$project$Message$NewInput = function (a) {
	return {ctor: 'NewInput', _0: a};
};
var _user$project$Message$NewNumbers = function (a) {
	return {ctor: 'NewNumbers', _0: a};
};
var _user$project$Message$ChangeLanguage = function (a) {
	return {ctor: 'ChangeLanguage', _0: a};
};
var _user$project$Message$CreateNumbers = {ctor: 'CreateNumbers'};

var _user$project$Commands$createNumbers = function (model) {
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$Message$NewNumbers,
		A2(
...
var _user$project$Translations_Norwegian$getText = function (label) {
	...
	switch (_p0.ctor) {
		...
		case 'Title':
			return _elm_lang$core$Maybe$Just('Gangetrening');
		default:
			return _elm_lang$core$Maybe$Just('Bruk tall opp til ');
	}
};
...
var _user$project$Translations_English$getText = function (label) {
	...
	switch (_p0.ctor) {
		...
		case 'Title':
			return _elm_lang$core$Maybe$Just('Multiplication practice');
		default:
			return _elm_lang$core$Maybe$Just('Use numbers up to ');
	}
};
...
var _user$project$Navbar$maxNumSelector = function (n) {
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Message$ChangeMaxNum(n)),
				_1: {ctor: '[]'}
			}
		},
		{
											...
											},
											{
												...
												_0: A2(
													...
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															t(_user$project$Translations_Types$CurrentMaxnum)),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(model.maxNum)),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html$span,
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																A2(
																	_elm_lang$core$List$map,
																	_user$project$Navbar$maxNumSelector,
																	{
																		ctor: '::',
																		_0: 2,
																		_1: {
